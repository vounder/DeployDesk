    ...
    private static readonly IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> Translations =
        new Dictionary<string, IReadOnlyDictionary<string, string>>(StringComparer.OrdinalIgnoreCase)
        {
            ["en"] = new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                ["SavedProjectsLoadFailed"] = "Some saved projects could not be loaded. Their entries were kept so the problem can be corrected.\n\n{0}",
            ...
            ["de"] = new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                ["SavedProjectsLoadFailed"] = "Einige gespeicherte Projekte konnten nicht geladen werden. Ihre Einträge wurden beibehalten, damit das Problem behoben werden kann.\n\n{0}",
